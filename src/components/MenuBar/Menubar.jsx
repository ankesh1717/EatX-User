          ...
          <div className="d-flex align-items-center gap-4">
            <Link to={"/cart"}>
              <div className="position-relative cursor">
                ...
                />
                <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill pop-up">
                  {uniqueItemsInCart}
                </span>
              </div>
            </Link>
            ...
            >
              Register
                    ...
                    <a href="" className="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                      <img src={assets.Profile} alt="" width={37} height={32} className="rounded-circle" />
                    </a>
